...
namespace Lean.Touch
{
	...
	{
        public _transformDirection transformDirection;
        public enum _transformDirection { XZ, Y,XYZ };
               ...
               switch(transformDirection)
                {
                    case _transformDirection.XZ:
                        ...
                        break;
                    case _transformDirection.Y:
                        transform.position = new Vector3(transform.position.x, camera.ScreenToWorldPoint(screenPoint).y, transform.position.z);
                        break;
                    case _transformDirection.XYZ:
